...
const Navbar = ({ isDarkMode, toggleTheme }) => {
  ...
  const getProfileImgUrl = (path) => {
    ...
    if (path.startsWith('/uploads/')) return `${import.meta.env.VITE_API_BASE_URL || 'https://square-net-backend-production.up.railway.app'}${path.replace('/uploads/', '/')}`;
    if (path.startsWith('/')) return `${import.meta.env.VITE_API_BASE_URL || 'https://square-net-backend-production.up.railway.app'}${path}`;
    return `${import.meta.env.VITE_API_BASE_URL || 'https://square-net-backend-production.up.railway.app'}/${path}`;
  };
